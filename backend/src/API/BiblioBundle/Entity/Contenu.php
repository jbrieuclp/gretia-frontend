...
class Contenu
{
     ...
     * @ORM\SequenceGenerator(sequenceName="biblio.contenu_id_contenu_seq", allocationSize=1, initialValue=1)
		 *
	   ...
	   * Owning Side
	   *
	   * @ORM\ManyToMany(targetEntity="API\BiblioBundle\Entity\Publication", mappedBy="contenus", cascade={"persist", "merge"})
