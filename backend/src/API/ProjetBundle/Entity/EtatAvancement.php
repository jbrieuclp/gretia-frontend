...
/**
* @ORM\Entity
* @ORM\Table(name="projet.etat_avancement")
...
class EtatAvancement
{
  ...
  /**
   * @ORM\Id
   * @ORM\Column(name="id_etat_avancement", type="integer")
   * @ORM\GeneratedValue(strategy="SEQUENCE")
   * @ORM\SequenceGenerator(sequenceName="projet.etat_avancement_id_etat_avancement_seq", allocationSize=1, initialValue=1)
   *
  ...
  /**
   * @ORM\OneToMany(targetEntity="API\ProjetBundle\Entity\Tache", mappedBy="avancement", cascade={"all"}, orphanRemoval=true, fetch="EAGER")
   *
