...
/**
* @ORM\Entity
* @ORM\Table(name="taxref.taxref_4")
*/
class Taxref4
{
     ...
     *
     * @Serializer\Groups({"taxon", "taxref4"})
     */
    private $cdNom;
    ...
    /**
     * @ORM\Column(name="aphia_id", type="string", nullable=true)
     *
     * @Serializer\Groups({"taxon", "taxref4"})
     */
    private $aphia;
     ...
     * @return Taxref
     */
    public function setAphia($aphia)
    {
        $this->aphia = $aphia;
