...
/**
* @ORM\Entity
* @ORM\Table(name="taxref.taxref_11")
*/
class Taxref11
{
     ...
     *
     * @Serializer\Groups({"taxon", "taxref11"})
     */
    private $cdNom;
    ...
    */
    ...
    /**
    * @ORM\Column(name="nom_complet_html", type="string", nullable=true)
     *
     * @Serializer\Groups({"taxon", "taxref11"})
    */
    ...
    /**
     * @ORM\Column(name="group1_inpn", type="string", nullable=true)
     *
     * @Serializer\Groups({"taxon", "taxref11"})
     */
    private $group1Inpn;
    ...
    /**
     * @ORM\Column(name="group2_inpn", type="string", nullable=true)
     *
     * @Serializer\Groups({"taxon", "taxref11"})
     */
    private $group2Inpn;
    ...
    /**
     * @ORM\Column(name="cd_sup", type="integer")
     *
     * @Serializer\Groups({"taxon", "taxref11"})
     */
    private $cdSup;
    ...
    /**
     * @ORM\Column(name="sa", type="string", nullable=true)
     *
     * @Serializer\Groups({"taxon", "taxref11"})
     */
    private $sa;
     ...
     * Set group2Inpn
     *
     * @param integer $group2Inpn
     * @return Taxref
     */
    public function setGroup2Inpn($groupe2Inpn)
    {
